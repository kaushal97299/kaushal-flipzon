...
function Signup() {
  ...
  const sendOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.post("https://ecommerce-atbk.onrender.com/api/auth/send-otp", {
  ...
  const verifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.post("https://ecommerce-atbk.onrender.com/api/auth/verify-otp", {
        email: formData.email,
        enteredOtp: otp,
      });
