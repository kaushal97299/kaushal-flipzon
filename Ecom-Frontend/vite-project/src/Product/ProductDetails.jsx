...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProductAndReviews = async () => {
      setLoading(true);
      try {
        const productResponse = await axios.get(`https://ecommerce-atbk.onrender.com/api/products/prod/${id}`);
        setProduct(productResponse.data);

        const reviewsResponse = await axios.get(`https://ecommerce-atbk.onrender.com/api/reviews/rew/${id}`);
  ...
  const handleReviewSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://ecommerce-atbk.onrender.com/api/reviews/rew", reviewData, config);
  ...
  const handleDeleteReview = async (reviewId) => {
    ...
    try {
      ...
      await axios.delete(`https://ecommerce-atbk.onrender.com/api/reviews/${reviewId}`, config);
